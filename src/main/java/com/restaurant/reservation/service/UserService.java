  ...
  /*  *//**
    ...
    private List<Map<String, Object>> getFavoriteStoresFallback(String userId) {
        ...
        for (FavoriteStore fs : favoriteStores) {
            ...
            store.put("storeName", fs.getStoreName());
...
*/
  ...
  /*  *//**
     * 즐겨찾기 가게 추가
     *//*
    public FavoriteStoreDto addFavoriteStore(String userId, String storeId, String storeName) {
        ...
        // 즐겨찾기 가게 생성
        FavoriteStore favoriteStore = new FavoriteStore(userId, storeId, storeName);
        FavoriteStore savedFavoriteStore = favoriteStoreRepository.save(favoriteStore);
        
        FavoriteStoreDto dto = new FavoriteStoreDto(
            savedFavoriteStore.getFavStoreId(), savedFavoriteStore.getStoreId(),
                savedFavoriteStore.getStoreName(), savedFavoriteStore.getUserId()
        );
    ...
    private List<Map<String, Object>> getRecentFavorites(String userId, int limit) {
        ...
        return favorites.stream()
            ...
            .map(fs -> {
                ...
                fav.put("storeName", fs.getStoreName());
